...
- Full-package generation must pass a content-uniqueness validation before final delivery. When available, run `node ova-json-content/scripts/validate_content_package.js <generated-json-files>` and treat duplicate long strings or repeated 12-word sequences across thematic sections as blocking errors.
