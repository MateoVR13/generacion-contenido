...
2. Read the internal mandatory references bundled with this skill before generating complete content:
   ...
   - `identidad_marca.md`
   - `meta_prompt_maestro_cursos_virtuales.md`
...
Generated asignaturas are 100% virtual and must use only AG - Aprendizaje Guiado. Do not choose or mention other active methodologies in generated JSON.
...
- Run content uniqueness validation before finalizing. If Node.js is available, run `node ova-json-content/scripts/validate_content_package.js <generated-json-files>` and revise until repeated learner-facing content is eliminated.
