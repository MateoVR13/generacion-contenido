...
```bash
node aprendizaje-basado-investigacion-scorm/scripts/validate_content_package.js <slug-asignatura>-contenido-01.json <slug-asignatura>-contenido-02.json <slug-asignatura>-contenido-03.json <slug-asignatura>-contenido-04.json
```
