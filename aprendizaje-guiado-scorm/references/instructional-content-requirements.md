...
- Run content uniqueness validation before finalizing. If Node.js is available, run `node aprendizaje-guiado-scorm/scripts/validate_content_package.js <generated-json-files>` and revise until repeated learner-facing content is eliminated.
