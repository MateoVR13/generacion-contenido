...
- Run the content uniqueness validation pass from `references/content-uniqueness-validation.md`; when possible execute `node aprendizaje-guiado-scorm/scripts/validate_content_package.js <generated-json-files>` and revise until it passes.
