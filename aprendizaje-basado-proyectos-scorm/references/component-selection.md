...
- It is conceptually and textually unique within the full three-file package; no paragraph, bullet, prompt, example, feedback, visual prompt, practice step, or code scaffold is reused as a shell.
