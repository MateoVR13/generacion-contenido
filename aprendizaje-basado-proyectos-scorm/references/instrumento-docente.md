# Instrumento de validación docente (ABPr) — contrato

Es la **salida del Pipeline 1** y la **entrada del Pipeline 2**. Lo responde el profesor que estará a cargo
de la virtualización. Debe ser claro, editable y específico de ABPr. Se entrega en `.md` (+ `.docx` opcional +
...
3. **Estructura por momentos ABPr (3 momentos fijos)** — tabla planeada en F2, el docente valida:
   | Momento (fijo) | RA asociado | Propósito del momento | Preguntas orientadoras | ¿Aprobado? / ajustes |
   - Los **momentos son siempre 3 y en este orden:** **Diagnóstico Inicial**, **Análisis y Diseño**,
     **Conclusiones**. El docente **NO cambia la cantidad ni el orden de los momentos** (son fijos en ABPr);
     valida y ajusta **propósitos, preguntas orientadoras y subtemas**.
   - ¿Los propósitos y preguntas orientadoras de cada momento son correctos disciplinarmente? Recuerda que el
     proyecto avanza del **diagnóstico del problema** → **análisis y diseño de la solución** → **socialización
     del producto** (trabajo colaborativo en equipos).
...
4. **Actividades y TALLERES del estudiante por momento (requiere aprobación del profesor):**
   ...
   - Para cada momento, ¿qué **actividades** debe realizar el estudiante (individuales y colaborativas en
     equipo)?
   - ¿Los talleres y actividades propuestos son pertinentes para el avance del proyecto? ¿Qué agregar/cambiar?
...
6. **Evaluación** (propuesta en F3, el docente valida):
   - Diagnóstica (10/15), formativas de seguimiento, sumativa integradora (socialización del proyecto), foro
     debate, wiki, coevaluación de equipo.
