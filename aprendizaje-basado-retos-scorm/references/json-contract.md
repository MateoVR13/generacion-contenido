...
New asignatura generation produces four independent JSON files, one per Aprendizaje Basado en Retos learning moment:

- `<slug-asignatura>-contenido-01.json` → Definición del reto
- `<slug-asignatura>-contenido-02.json` → Ideación
- `<slug-asignatura>-contenido-03.json` → Solución e implementación
- `<slug-asignatura>-contenido-04.json` → Validación y evaluación
...
"methodology": {
  "code": "ABR",
  "name": "Aprendizaje Basado en Retos",
  "rationale": "Ruta de reto que prepara al estudiante para idear, implementar, validar y evaluar una solución a un reto, con acompañamiento, práctica y retroalimentación.",
  "moments": ["Definición del reto", "Ideación", "Solución e implementación", "Validación y evaluación"]
}
```
...
```json
{
  ...
  "methodologyMoment": "Definición del reto",
