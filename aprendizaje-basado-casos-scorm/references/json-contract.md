...
New asignatura generation produces four independent JSON files, one per Aprendizaje Basado en Casos learning moment:

- `<slug-asignatura>-contenido-01.json` — "Presentación y análisis del caso"
- `<slug-asignatura>-contenido-02.json` — "Análisis de pregunta orientadora o micro caso 1"
- `<slug-asignatura>-contenido-03.json` — "Análisis de pregunta orientadora o micro caso 2"
- `<slug-asignatura>-contenido-04.json` — "Conclusiones"
...
`subject.methodology` is required for full asignatura package generation. For virtual asignaturas, always use ABC - Aprendizaje Basado en Casos:

```json
"methodology": {
  "code": "ABC",
  "name": "Aprendizaje Basado en Casos",
  "rationale": "Análisis de un caso real de la disciplina: presentación del caso, análisis de preguntas orientadoras o micro casos y conclusiones, con acompañamiento, práctica y retroalimentación.",
  "moments": ["Presentación y análisis del caso", "Análisis de pregunta orientadora o micro caso 1", "Análisis de pregunta orientadora o micro caso 2", "Conclusiones"]
}
```
...
```json
{
  ...
  "methodologyMoment": "Presentación y análisis del caso",
...
For complete asignatura generation, the package contains 20 thematic sections: four contents (learning moments) times five thematic sections. These 20 sections must be unique in concept, explanation, example, activity, visual support, assessment, and RA evidence.
...
"pdf": {
  ...
  "kicker": "Aprendizaje basado en casos · Análisis aplicado · Autoevaluación",
